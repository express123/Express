...
<script>
$(function(){
	var id1="#updateWebsitemanagerStaff_staff_sname";
	var id2="#updateWebsitemanagerStaff_staff_saddress";
	var id3="#updateWebsitemanagerStaff_staff_sphone";
	var id4="#updateWebsitemanagerStaff_staff_spd";
	$(id1).blur(function(){
