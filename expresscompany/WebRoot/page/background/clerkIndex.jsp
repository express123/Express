 ...
 <title>业务员管理页面</title>
  ...
  <body>
	<div id="body1">
		<br><br><br><br>
		<center>
		<font id="p1">您好，${session.staff.sid}</font><br>
		<font id="p1">您的个人信息完整度为：<s:property value="ratio"/>%</font><br>
		<font id="p1">可以点此</font>&nbsp;&nbsp;<a href="/expresscompany/page/background/updateClerkData.jsp" target="backshowiframe" ><font id="p1" color="#9CF">完善资料</font></a>&nbsp;&nbsp;<font id="p1">哦</font>
		</center>
	</div>
	<br><br>
	<div id="body2">
