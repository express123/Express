...
<html>
  ...
  <p id="p6">订单确认信息</p>
    ...
    <s:form method="post" namespace="/orders" action="ADDorders"  theme="simple">
		...
		<br>
			<center>
			<s:submit style="background:brown; color:white; font-size:30px" value="确认订单" onClick="showSuccess()" />
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="button"   value="取消下单" style="background:brown; color:white; font-size:30px" onClick="backIndex()"/>
			</center>
		<br><br><br>
		</div>
		</s:form>
	...
	function backIndex(){
    	window.open("/expresscompany/page/foreground/showIndex.jsp",target="showiframe");
    }
	</script>
  </body>
</html>
